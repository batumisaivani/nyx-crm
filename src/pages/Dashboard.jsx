  ...
  return (
    <Layout>
      <div className="w-full -mt-4">
        <div className="mb-3">
          <h2 className="text-2xl font-bold text-white font-[Calibri,sans-serif]">Dashboard</h2>
        </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <AnimatedCard className="p-6">
                <div className="text-sm text-purple-200 mb-1">Today's Bookings</div>
                <div className="text-3xl font-bold text-white">{stats.todayBookings}</div>
                <div className="text-xs text-purple-300 mt-1">Total: {stats.totalBookings}</div>
              </AnimatedCard>

              <AnimatedCard className="p-6">
                <div className="text-sm text-purple-200 mb-1">Active Services</div>
                <div className="text-3xl font-bold text-white">{stats.services}</div>
                <div className="text-xs text-purple-300 mt-1">Available to book</div>
              </AnimatedCard>

              <AnimatedCard className="p-6">
                <div className="text-sm text-purple-200 mb-1">Specialists</div>
                <div className="text-3xl font-bold text-white">{stats.specialists}</div>
                <div className="text-xs text-purple-300 mt-1">Team members</div>
              </AnimatedCard>

              <AnimatedCard className="p-6">
                <Link to="/reports" className="block">
                  <div className="text-sm text-purple-200 mb-1">Revenue</div>
                  <div className="text-3xl font-bold text-white">{stats.revenue.toFixed(2)} GEL</div>
                  <div className="text-xs text-purple-300 mt-1 hover:text-white">View detailed reports →</div>
                </Link>
              </AnimatedCard>
            </div>
            ...
            <div className="relative bg-gradient-to-r from-purple-900/15 to-violet-900/15 backdrop-blur-xl rounded-lg border border-purple-700 shadow-2xl p-6 mb-8">
              <h3 className="text-lg font-bold text-white mb-4 font-[Calibri,sans-serif]">Quick Actions</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <AnimatedCard className="p-4">
                  <Link to="/calendar" className="block text-left">
                    <CalendarDays className="w-6 h-6 mb-2 text-purple-300" />
                    <div className="text-sm font-medium text-white">View Calendar</div>
                    <div className="text-xs text-purple-200 mt-1">See today's schedule</div>
                  </Link>
                </AnimatedCard>
                ...
                <AnimatedCard className="p-4">
                  <Link to="/reports" className="block text-left">
                    ...
                    <div className="text-xs text-purple-200 mt-1">Analytics & insights</div>
                  </Link>
                </AnimatedCard>

                <AnimatedCard className="p-4">
                  <Link to="/services" className="block text-left">
                    <Scissors className="w-6 h-6 mb-2 text-purple-300" />
                    <div className="text-sm font-medium text-white">Manage Services</div>
                    <div className="text-xs text-purple-200 mt-1">Add or edit services</div>
                  </Link>
                </AnimatedCard>
                ...
                <AnimatedCard className="p-4">
                  <Link to="/specialists" className="block text-left">
                    ...
                    <div className="text-sm font-medium text-white">Manage Specialists</div>
                    <div className="text-xs text-purple-200 mt-1">Add or edit team members</div>
                  </Link>
                </AnimatedCard>

                <AnimatedCard className="p-4">
                  <Link to="/profile" className="block text-left">
                    <Building2 className="w-6 h-6 mb-2 text-purple-300" />
                    <div className="text-sm font-medium text-white">Edit Profile</div>
                    <div className="text-xs text-purple-200 mt-1">Update facility info</div>
                  </Link>
                </AnimatedCard>
                ...
                <AnimatedCard className="p-4">
                  <Link to="/bookings" className="block text-left">
                    ...
                    <div className="text-sm font-medium text-white">Recent Bookings</div>
                    <div className="text-xs text-purple-200 mt-1">View all bookings</div>
                  </Link>
                </AnimatedCard>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <div className="relative bg-gradient-to-r from-purple-900/15 to-violet-900/15 backdrop-blur-xl rounded-lg border border-purple-700 shadow-2xl p-6">
                <h3 className="text-lg font-bold text-white mb-4 font-[Calibri,sans-serif]">Performance Overview</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between pb-3 border-b border-purple-500/20">
                    <div>
                      <p className="text-sm text-gray-300">Today's Revenue</p>
                      <p className="text-2xl font-bold text-purple-400">{(stats.revenue * 0.15).toFixed(2)} GEL</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between pb-3 border-b border-purple-500/20">
                    <div>
                      ...
                      <p className="text-xl font-bold text-purple-400">45 min</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs text-gray-400">Efficiency</p>
                      <p className="text-sm font-semibold text-green-400">95%</p>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-gray-300">Customer Satisfaction</p>
                      <p className="text-xl font-bold text-purple-400">4.8 / 5.0</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs text-gray-400">Reviews</p>
                      <p className="text-sm font-semibold text-gray-300">124</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Monthly Trend Chart */}
              <div className="relative bg-gradient-to-r from-purple-900/15 to-violet-900/15 backdrop-blur-xl rounded-lg border border-purple-700 shadow-2xl p-6">
                <h3 className="text-lg font-bold text-white mb-4 font-[Calibri,sans-serif]">Monthly Bookings Trend</h3>
                    ...
                    return (
                      <div key={week}>
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-sm font-semibold text-purple-400">{Math.floor(stats.monthBookings * (percentage / 100))}</span>
                        </div>
            ...
            {/* Top Services Table */}
            <div className="relative bg-gradient-to-r from-purple-900/15 to-violet-900/15 backdrop-blur-xl rounded-lg border border-purple-700 shadow-2xl p-6 mb-8">
              <h3 className="text-lg font-bold text-white mb-4 font-[Calibri,sans-serif]">Top Performing Services</h3>
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-purple-500/20">
                      <th className="text-left py-3 px-4 text-sm font-semibold text-gray-300">Service</th>
                      <th className="text-center py-3 px-4 text-sm font-semibold text-gray-300">Bookings</th>
                      <th className="text-center py-3 px-4 text-sm font-semibold text-gray-300">Revenue</th>
                      <th className="text-right py-3 px-4 text-sm font-semibold text-gray-300">Growth</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      <tr key={index} className="border-b border-purple-500/10 hover:bg-purple-900/15 transition-colors">
                        <td className="py-3 px-4 text-sm text-white font-medium">{service.name}</td>
                        <td className="py-3 px-4 text-sm text-center text-gray-300">{service.bookings}</td>
                        <td className="py-3 px-4 text-sm text-center text-purple-400 font-semibold">{service.revenue} GEL</td>
                        <td className="py-3 px-4 text-sm text-right text-green-400 font-semibold">{service.growth}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            {(stats.services === 0 || stats.specialists === 0) && (
              <div className="bg-gradient-to-r from-purple-900/15 to-violet-900/15 border border-purple-700 rounded-lg p-6">
                <h3 className="text-lg font-bold text-white mb-3 font-[Calibri,sans-serif]">Complete Your Setup</h3>
                <div className="space-y-3">
                  {stats.services === 0 && (
                    <Link to="/services" className="flex items-center justify-between p-3 bg-gray-800 rounded-lg hover:shadow-md hover:border-purple-600 border border-transparent transition-all">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-white">Add your first service</p>
                          <p className="text-xs text-gray-300">Create your service catalog with pricing</p>
                        </div>
                      </div>
                  ...
                  {stats.specialists === 0 && (
                    <Link to="/specialists" className="flex items-center justify-between p-3 bg-gray-800 rounded-lg hover:shadow-md hover:border-purple-600 border border-transparent transition-all">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-white">Add your first specialist</p>
                          <p className="text-xs text-gray-300">Add your team members and assign services</p>
                        </div>
                      </div>
                      <span className="text-purple-400">→</span>
                    </Link>
